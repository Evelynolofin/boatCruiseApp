...
//     setActiveFilter(key);
//     dropAnim.setValue(-PANEL_HEIGHT);
...
//  const getImageUrl = (boat: Boat): string => {
//   if (boat.media) {
//     if (typeof boat.media === "string") {
//       return boat.media.startsWith("http")
//         ? boat.media
//         : `https://internsproject.vercel.app${boat.media}`;
//     }

//     if (Array.isArray(boat.media) && boat.media.length > 0) {
//       const firstMedia = boat.media[0];

//       if (typeof firstMedia === "string") {
//         return firstMedia.startsWith("http")
//           ? firstMedia
//           : `https://internsproject.vercel.app${firstMedia}`;
//       }
...
//         "url" in firstMedia
//       ) {
//         const mediaObj = firstMedia as MediaItem;
//         const urlStr = mediaObj.url;

//         return urlStr.startsWith("http")
//           ? urlStr
//           : `https://internsproject.vercel.app${urlStr}`;
//       }
//     }
//   }
...
//       return boat.images.startsWith("http")
//         ? boat.images
//         : `https://internsproject.vercel.app${boat.images}`;
//     }
...
//           ? firstImage
//           : `https://internsproject.vercel.app${firstImage}`;
//       }
//     }
//   }

//   if (boat.imageUrl) {
//     return boat.imageUrl.startsWith("http")
//       ? boat.imageUrl
//       : `https://internsproject.vercel.app${boat.imageUrl}`;
//   }
...
//     } catch (error) {
//       Alert.alert("Failed to load boats", (error as any).message || JSON.stringify(error));
//     }
//   };
...
//                 backgroundColor: 'white', borderRadius: 4, paddingHorizontal: 5.5,
//                 paddingVertical: 10,
//               }}
//               >
//                 <Image
                  ...
                  {filteredBoats.map((b) => (
                    ...
                    >
                      {b.media && (
                        <Image
                          source={{ 
                            uri: typeof b.media === 'string' 
                              ? (b.media.startsWith('http') 
                                  ? b.media 
                                  : `https://internsproject.vercel.app${b.media}`)
                          ...
                          style={{ width: 150, height: 100, borderRadius: 5 }}
                          resizeMode="cover"
                          onError={(e) => console.log('Image load error for', b.boatName, e.nativeEvent.error)}
                        />
                      )}
