...
export default function BookingPage() {
  ...
  const createBooking = async () => {
    ...
    try {
      ...
      if (
        ...
        Alert.alert("Invalid Guest Count", errorMessage, [
          {
  ...
  const verifyPayment = async (reference: string) => {
    ...
    try {
      ...
      const paymentStatus =
        ...
        verificationData?.data?.paymentStatus;
  ...
  useEffect(() => {
    if (paymentReference) {
      ...
      console.log(
        "Verification URL:",
        `https://internsproject.vercel.app/api/bookings/verify/${paymentReference}`,
      );
      console.log("======================");
    }
  }, [paymentReference]);
    ...
    <>
      ...
      >
        <View style={{ paddingHorizontal: 10, paddingVertical: 20 }}>
          ...
          >
            <Ionicons name="arrow-back" size={18} color="#292D329E" />
            <Text style={{ fontWeight: 400, fontSize: 14, color: "#292D329E" }}>
              Go back
            </Text>
          </TouchableOpacity>
        </View>
          ...
          >
            <View style={styles.stepBox}>
              ...
              >
                <Text
                  style={
                    step === 1 ? styles.activeNumber : styles.inactiveNumber
                  }
                >
                  {" "}
                  1{" "}
            ...
            <View style={styles.stepBox}>
              ...
              >
                <Text
                  style={
                    step === 2 ? styles.activeNumber : styles.inactiveNumber
                  }
                >
                  {" "}
                  2{" "}
            ...
            <View style={styles.stepBox}>
              ...
              >
                <Text
                  style={
                    step === 3 ? styles.activeNumber : styles.inactiveNumber
                  }
                >
                  {" "}
                  3{" "}
              ...
              <Text
                style={step === 3 ? styles.activeLabel : styles.inactiveLabel}
              >
                Payment
              </Text>
            </View>
          ...
          <View>
            {step === 1 && (
              <View>
                ...
                <View
                  style={{
                    marginVertical: 11.32,
                    paddingHorizontal: 10,
                    backgroundColor: "white",
                    borderRadius: 11.69,
                    marginHorizontal: 14,
                    paddingVertical: 11.32,
                    justifyContent: "center",
                  }}
                >
                  <Text
                  ...
                  <View>
                    ...
                    >
                      <Text style={styles.footerLabel}>
                        ₦{pricePerHour.toLocaleString()} × {duration} hour
                      </Text>
                      <Text style={styles.footerText}>
                  ...
                  >
                    <View>
                      ...
                      <Text>
                        ...
                        payment securely. Paystack accepts card payments, bank
                    ...
                    {showSuccess && paymentReference && (
                      <Modal isVisible={showSuccess}>
                        <View style={styles.modalCard}>
                          ...
                          >
                            Your booking has been confirmed and the operator has
                            been notified.
                          </Text>
                          ...
                          <View
                            style={{
                              ...
                              paddingVertical: 10.29,
                              marginVertical: 10,
                              borderRadius: 4.12,
                            }}
                          >
                            <View
                              style={[styles.info, { paddingHorizontal: 8 }]}
                            >
                              <Text style={styles.footerLabel}>
                                {" "}
                                Booking ID:
